...
public class Comment extends Conteudo implements ConteudoIndexavel {
    ...
    public Comment(Entity commentEntity) {
        ...
        this.arvore = new Converters().toBoolean(String.valueOf(commentEntity.getProperty(CommentFields.TREE.getField())));
    }
    ...
    public Document toDocument() {
        Document document = Document.newBuilder().setId(id)
                ...
                .addField(Field.newBuilder().setName(CommentFields.TREE.getField()).setText(String.valueOf(this.arvore)))
