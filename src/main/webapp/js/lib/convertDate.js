...
var MONTH_NAMES = new Array('Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio',
		...
		'Set', 'Out', 'Nov', 'Dez');
var DAY_NAMES = new Array('Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta',
		'Sexta', 'Sábado', 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab');
...
function formatDate(date, format) {
	...
	value = setPossibleFormatsValues(year, month, dayOfMonth, dayOfWeek, hour,
			minute, second);
...
function setPossibleFormatsValues(year, month, dayOfMonth, dayOfWeek, hour,
		minute, second) {
	var value = new Object();
